...
const installGuides: Record<PlatformKey, { zh: string[]; en: string[] }> = {
  ...
  android: {
    zh: ["从 v0.3.0 或更高版本可直接覆盖安装 v0.4.1；只有 v0.2.0 需先卸载一次。", "下载 APK，系统询问时允许浏览器安装未知来源应用。", "确认文件来自本官网后，选择“仍要安装”；安装后可关闭该权限。"],
    en: ["v0.3.0 and newer can update directly to v0.4.1. Only v0.2.0 requires one uninstall first.", "Download the APK and allow your browser to install unknown apps when Android asks.", "After verifying this official site, choose Install anyway. You can revoke that permission afterward."],
  },
};
