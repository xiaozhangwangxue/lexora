...
| --- | --- | --- | --- |
| Android | APK | Android 8.0+ | [Official mirror](https://lexora.12323456.xyz/downloads/lexora-android-v0.4.1.apk) |
| macOS | Drag-to-install DMG | macOS 12+ | [Official mirror](https://lexora.12323456.xyz/downloads/lexora-macos-v0.4.1.dmg) |
| Windows | ZIP | Windows 10 / 11 | [Official mirror](https://lexora.12323456.xyz/downloads/lexora-windows-v0.4.1.zip) |
| Linux | tar.gz | 64-bit Linux | [Official mirror](https://lexora.12323456.xyz/downloads/lexora-linux-v0.4.1.tar.gz) |
...
Every release filename contains its version, such as `lexora-android-v0.4.1.apk`, so old and new installers remain easy to distinguish.
