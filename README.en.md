...
| --- | --- | --- | --- |
| Android | APK | Android 8.0+ | [Official mirror](https://lexora.12323456.xyz/downloads/lexora-android-v3.2.4.apk) |
| macOS | Drag-to-install DMG | macOS 12+ | [Official mirror](https://lexora.12323456.xyz/downloads/lexora-macos-v3.2.4.dmg) |
| Windows | Setup EXE (launch option checked by default) | Windows 10 / 11 | [Official mirror](https://lexora.12323456.xyz/downloads/lexora-windows-v3.2.4-setup.exe) |
| Linux | tar.gz | 64-bit Linux | [Official mirror](https://lexora.12323456.xyz/downloads/lexora-linux-v3.2.4.tar.gz) |
...
Every release filename contains its version, such as `lexora-android-v3.2.4.apk`, so old and new installers remain easy to distinguish. The website keeps 3.1.0 under Previous versions and it will remain in R2. In-app updates prefer Cloudflare R2 and verify download completeness plus SHA-256 before opening an installer.
