  ...
  Future<void> _shareSelected(List<GeneratedBook> books) async {
    ...
    if (files.isEmpty) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text(strings.noFilesToShare)));
      return;
    }
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    subtitle: Text(
                                      '${strings.termCount(book.wordCount)} · ${_formatDate(book.createdAt)}',
                                    ),
                                    onTap: _selecting
                                        ? () => _toggleBook(book.id)
